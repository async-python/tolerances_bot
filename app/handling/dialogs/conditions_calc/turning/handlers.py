...
async def _process_turning_conditions(
    ...
    dialog_manager.dialog_data.update({"turning": result.model_dump()})
...
async def on_cutting_speed_received(
    ...
    await dialog_manager.switch_to(state=ConditionsTurningSG.window_4)
...
async def go_window_1(
    ...
    """Switch to window 1."""
    await dialog_manager.switch_to(state=ConditionsTurningSG.window_1)
...
async def go_window_2(
    ...
    """Switch to window 2."""
    await dialog_manager.switch_to(state=ConditionsTurningSG.window_2)
...
async def go_window_3(
    ...
    """Switch to window 3."""
    await dialog_manager.switch_to(state=ConditionsTurningSG.window_3)
