"""Conditions turning dialog handlers."""
...
async def on_start(
    ...
    return dialog_manager.dialog_data.update(start_data)


async def _process_turning_conditions(
    message: Message,
    ...
    return dialog_manager.dialog_data.update(
        {"turning": result.model_dump(mode="json")}
    )
...
async def on_diameter_received(
    ...
    await _process_turning_conditions(
        message=message,
...
async def on_cutting_speed_received(
    ...
    return await dialog_manager.switch_to(state=ConditionsTurningSG.window_4)
...
async def on_feed_rate_received(
    ...
    return await _process_turning_conditions(
        message=message,
...
async def go_window_1(
    ...
    """Switch to window 1."""
    return await dialog_manager.switch_to(state=ConditionsTurningSG.window_1)
...
async def go_window_2(
    ...
    """Switch to window 2."""
    return await dialog_manager.switch_to(state=ConditionsTurningSG.window_2)
...
async def go_window_3(
    ...
    """Switch to window 3."""
    return await dialog_manager.switch_to(state=ConditionsTurningSG.window_3)
...
async def go_window_5(
    ...
    """Switch to window 5."""
    return await dialog_manager.switch_to(state=ConditionsTurningSG.window_5)
